...
{
    public class ReservasVisitante
    {
        public ReservasVisitante(string nombre, int id, string motivo, string sitio, int identificacionPersona, string placa, TimeSpan horaEntrada, TimeSpan horaSalida, int idEspacio, int idEstacionamiento)
        {
            Nombre = nombre;
            Id = id;
            Motivo = motivo;
